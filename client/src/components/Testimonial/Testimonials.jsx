  ...
  return (
    <Slider {...settings}>
      <div className="testimonials py-4 px-3">
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe praesentium modi deleniti ex, illum at id molestiae natus exercitationem ratione similique accusantium?</p>
      ...
      <div className="testimonials py-4 px-3">
        ...
        <div className="d-flex align-items-center gap-4 mt-3">
          ...
          <div>
            <h6 className='mb-0 mt-3'>Jake Doe</h6>
            <p>Customer</p>
          </div>
        </div>
      </div>
